...
By default the SDK can be used without a license, but only allows two sensors two connect. To allow for unlimited number of sensors to connect, a license is required. To obtain a license, please contact [sales@proavatar.io](mailto:sales@proavatar.io?subject=[GitHub]%20MotionCapture SDK license).
